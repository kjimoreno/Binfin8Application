...
var EvmLog = /** @class */ (function () {
    function EvmLog(input) {
        this.logIndex = input.logIndex;
        this.transactionHash = input.transactionHash;
        this.transactionIndex = input.transactionIndex;
        this.address = EvmAddress.create(input.address);
    ...
    EvmLog.create = function (input) {
        if (input instanceof EvmLog) {
            return input;
        }
        return new EvmLog(input);
    };
    EvmLog.fromJSON = function (json) {
        var input = {
    ...
    EvmLog.prototype.toJSON = function () {
        return {
...
var EvmWalletHistoryTransaction = /** @class */ (function () {
    function EvmWalletHistoryTransaction(input) {
        ...
        this.logs = input.logs ? input.logs.map(function (item) { return EvmLog.create(item); }) : undefined;
    }
    ...
    EvmWalletHistoryTransaction.fromJSON = function (json) {
        var input = {
            ...
            logs: json.logs ? json.logs.map(function (item) { return EvmLog.fromJSON(item); }) : undefined,
        };
...
var GetWalletHistoryOperation = {
    ...
    serializeRequest: function (request) {
        ...
        var includeLogsData = request.includeLogsData;
        var nftMetadata = request.nftMetadata;
        var cursor = request.cursor;
        var order = request.order ? EvmOrderList.create(request.order) : undefined;
        var limit = request.limit;
